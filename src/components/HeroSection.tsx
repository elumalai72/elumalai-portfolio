...
const HeroSection = () => {
  ...
  return (
    <section ref={sectionRef} className="relative h-screen w-full overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-black/50 via-transparent to-[#060608]" />
      ...
      <div className="relative z-10 flex h-full flex-col">
        ...
        <FadeIn delay={0} y={-20} className="relative">
          <div className="flex items-center justify-between px-6 md:px-10 pt-6 md:pt-8">
            <ul className="flex items-center gap-5 sm:gap-8 md:gap-12">
              {NAV_LINKS.map((link) => (
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="text-xs sm:text-sm font-medium uppercase tracking-[0.2em] text-white/80 transition hover:text-[#ff7a00]"
                  >
                    {link.label}
                  </a>
                </li>
            ...
            <a
              href="#contact"
              className="inline-flex items-center rounded-full border border-white/20 bg-white/10 px-4 py-2 sm:px-5 sm:py-2.5 text-[10px] sm:text-xs font-medium uppercase tracking-[0.2em] text-white backdrop-blur-md transition hover:bg-[#ff7a00]/20 hover:border-[#ff7a00]/40 hover:scale-[1.03]"
            >
              Email me
            </a>
          </div>
          ...
          <div className="w-full max-w-7xl px-6 md:px-10">
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 mb-4">
              <FadeIn delay={0.3} y={20}>
                <p className="text-[10px] sm:text-xs font-medium uppercase tracking-[0.35em] text-white/60">
                  Portfolio · 2026
                </p>
              </FadeIn>
              <FadeIn delay={0.4} y={20}>
                <span className="hidden sm:inline-block h-1 w-1 rounded-full bg-[#ff7a00]" />
              </FadeIn>
              <FadeIn delay={0.4} y={20}>
                <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.25em] text-[#ff7a00] bg-[#ff7a00]/10 px-3 py-1 rounded-full border border-[#ff7a00]/20 w-fit">
        ...
        <div className="flex items-end justify-between px-6 md:px-10 pb-7 sm:pb-10 md:pb-12">
          ...
          <FadeIn delay={1.1} y={20}>
            <a href="#about" aria-label="Scroll to next section" className="group flex flex-col items-center gap-3">
              <span className="text-[9px] sm:text-[10px] font-medium uppercase tracking-[0.35em] text-white/70 transition group-hover:text-[#ff7a00]">
                Scroll
              </span>
              <div className="relative h-12 w-px overflow-hidden bg-white/20">
                <span
                  className="absolute inset-x-0 top-0 h-1/2 w-full bg-[#ff7a00]"
          ...
          <FadeIn delay={1.1} y={20}>
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-full border border-white/20 bg-white/10 text-white backdrop-blur-md transition hover:bg-[#ff7a00]/20 hover:border-[#ff7a00]/40 hover:scale-110"
              >
                {muted ? (
